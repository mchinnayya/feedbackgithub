                    ...
                    template: function (data, i) {
                        ...
                        if (number > 5) {
                            output = '' +
                                ...
                                '<a href="#" class="kt-account-card-v2__name">' + data.Name + '</a>' +
                ...
                },
                {
                    ...
                    template: function (data, i) {
                        ...
                        var output = '' +
                            ...
                            '</div>' +
                            '<div class="kt-account-card-v2__details">' +
                            '<a href="#" class="kt-account-card-v2__name">' + data.Company + '</a>' +
                            '<span class="kt-account-card-v2__email">' + skills[number - 1] + '</span>' +
                            '</div>' +
                            '</div>';
