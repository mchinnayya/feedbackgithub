		...
		datatable = $('#kt_apps_user_list_datatable').KTDatatable({
			...
			columns: [{
				...
				template: function(data, i) {
					...
					var output = '\
                        <div class="kt-account-card-v2 kt-account-card-v2--uncircle">\
                            <div class="kt-account-card-v2__pic">\
                                <img src="assets/media/project-logos/' + img + '" alt="photo">\
                            </div>\
                            <div class="kt-account-card-v2__details">\
                                <a href="#" class="kt-account-card-v2__name">' + data.CompanyName + '</a>\
                                <span class="kt-account-card-v2__email">' +
				...
				template: function(data, i) {
					...
					var output = '';
					if (number > 5) {
						output = '<div class="kt-account-card-v2">\
								<div class="kt-account-card-v2__pic">\
									<img src="assets/media/users/' + user_img + '" alt="photo">\
								</div>\
								<div class="kt-account-card-v2__details">\
									<a href="#" class="kt-account-card-v2__name">' + data.CompanyAgent + '</a>\
									<span class="kt-account-card-v2__desc">' + position[pos] + '</span>\
								</div>\
							</div>';
					} else {
